...
class LarrockComponentDiscountServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        if ( !class_exists('AddForeignKeysToCartDiscountTable')){
            $migrations[__DIR__.'/database/migrations/0000_00_00_000000_add_foreign_keys_to_cart_table.php'] = database_path('migrations/'.$timestamp_after.'_add_foreign_keys_to_cart_discounts_table.php');
        }
        if ( !class_exists('AddForeignKeysToCategoryDiscountTable')){
            $migrations[__DIR__.'/database/migrations/0000_00_00_000000_add_foreign_keys_to_category_table.php'] = database_path('migrations/'.$timestamp_after.'_add_foreign_keys_to_category_discounts_table.php');
        }
