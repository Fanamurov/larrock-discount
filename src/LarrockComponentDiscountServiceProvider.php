...
class LarrockComponentDiscountServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $migrations = [];
        if ( !class_exists('CreateLarrockDiscountTable')){
        ...
        if ( !class_exists('UpdateLarrockCartDiscountsTable')){
        ...
        if ( !class_exists('UpdateLarrockCategoryDiscountsTable')){
        ...
        if ( !class_exists('AddForeignKeysToLarrockCartDiscountTable')){
        ...
        if ( !class_exists('AddForeignKeysToLarrockCategoryDiscountTable')){
